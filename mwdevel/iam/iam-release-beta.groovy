...
pipeline {
  ...
  parameters {
    ...
    string(name: 'GITHUB_REPO', defaultValue: 'marcocaberletti/test-lfs-repo', description: '')
  }
    ...
    stage('Publish to GitHub'){
      steps{
        ...
        script {
          ...
          def msg = "Upload ${env.TARGET} packages for ${params.PKG_TAG}"
          ...
          parameters: [
            ...
            string(name: 'TARGET', value: "${env.TARGET}"),
            string(name: 'COMMIT_MSG', value: "${msg}"),
          ]
        }
      }
    }
